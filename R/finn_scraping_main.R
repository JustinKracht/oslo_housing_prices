...
pages <- 4 #100 # Set the number of pages to scrape
prog_bar <- TRUE
mc_cores <- 4
# Set the starting page url
url <- "https://www.finn.no/realestate/homes/search.html?location=0.20061&property_type=3&property_type=1&property_type=4&property_type=2"
